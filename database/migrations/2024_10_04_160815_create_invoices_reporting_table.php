...
class CreateInvoicesReportingTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices_reporting', function (Blueprint $table) {
            ...
            $table->foreignId('barang_masuks_id')->nullable()->constrained('barang_masuks')->onDelete('cascade'); // Foreign key to barang_masuks table
            $table->foreignId('barang_keluars_id')->nullable()->constrained('barang_keluars')->onDelete('cascade'); // Foreign key to barang_keluars table
