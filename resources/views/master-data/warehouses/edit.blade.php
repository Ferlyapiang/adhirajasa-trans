            ...
            <div class="container">
                ...
                <form action="{{ route('master-data.warehouses.update', $warehouse->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="initial" name="initial" class="form-control" value="{{ old('name', $warehouse->name) }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="status_office" name="status_office" class="form-select" required>
                            <option value="head_office" {{ old('status_office', $warehouse->status_office) == 'head_office' ? 'selected' : '' }}>Kantor Pusat</option>
                            <option value="branch_office" {{ old('status_office', $warehouse->status_office) == 'branch_office' ? 'selected' : '' }}>Kantor Cabang</option>
                        </select>
                    </div>
                    <div class="mb-3">
