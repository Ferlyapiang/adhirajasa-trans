    ...
    <script>
        $(document).ready(function() {
            ...
            $('#paymentTypeFilter').on('change', function() {
                ...
                table.column(6).search(filterValue).draw(); // Adjusted index for payment type column
                updateTotals(); 
            });
            ...
            $('#updateStatusButton').on('click', function() {
                ...
                if (selectedIds.length > 0) {
                    ...
                    $.ajax({
                        url: '{{ route("invoice.update.status") }}', // Define the route to update status
                        method: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ids: selectedIds
                        ...
                        error: function(xhr) {
                            ...
                            console.error(xhr.responseJSON); // Log error details for debugging
                        }
                    });
                } else {
