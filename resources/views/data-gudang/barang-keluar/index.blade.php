                                    ...
                                    <table id="barangKeluarTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('data-gudang.barang-keluar.detail', $barangKeluar->id) }}">
                                                        {{ $barangKeluar->joc_number }}
                                                    </a>
                                                </td>
                                                <td>{{ $barangKeluar->jenis_mobil }}</td>
                                                <td>{{ $barangKeluar->nomer_polisi }}</td>
                                                <td>{{ $barangKeluar->nomer_container }}</td>
                                                <td>{{ $barangKeluar->fifo_in }}</td>
                                                <td>{{ $barangKeluar->fifo_out }}</td>
                                                <td>{{ $barangKeluar->fifo_sisa }}</td>
                                                <td>
                                                    <a href="{{ route('data-gudang.barang-keluar.edit', $barangKeluar->id) }}" class="btn btn-warning btn-sm">Edit</a>
